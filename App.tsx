                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-purple-500 font-medium"
                        value={newParticipantName}
                        onChange={e => setNewParticipantName(e.target.value)}
                        onKeyDown={e => e.key === 'Enter' && addParticipant(selectedEvent.id, newParticipantName)}
                      />
                      <button
                        onClick={() => addParticipant(selectedEvent.id, newParticipantName)}
                        className="px-6 py-3 bg-purple-600 text-white rounded-xl text-xs font-bold hover:bg-purple-700 transition-all shadow-lg shadow-purple-100"
                      >
                        Incluir
                      </button>
                    </div>
